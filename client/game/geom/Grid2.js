...
//   }
//
//   interpolate4CellsByPoint(point) {
//     // const cell = [Math.floor((point.x - .5 * this.cellSize) / this.cellSize)
//     //   , Math.floor((point.y - .5 * this.cellSize) / this.cellSize)];
//     // [
//     //   [cell[0] + 0, cell[1] + 0]
//     //   , [cell[0] + 0, cell[1] + 1]
//     //   , [cell[0] + 1, cell[1] + 0]
